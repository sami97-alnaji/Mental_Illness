...
class Test5Page extends StatefulWidget {
  ...
  Test5Page({required this.onTestCompleted});
...
class _Test5PageState extends State<Test5Page> {
  ...
  void initState() {
    super.initState();
    final int questionsPerPage = ((questions.length / 5).ceil());
  ...
  bool validatePage() {
    ...
    for (int i = 0; i < currentQuestions.length; i++) {
      int questionIndex = currentPage * ((questions.length / 5).ceil()) + i;
        ...
        child: Column(
          ...
          children: [
            ...
            ...List.generate(
              ...
              (index) {
                int questionIndex = currentPage * ((questions.length / 5).ceil()) + index;
                return Padding(
