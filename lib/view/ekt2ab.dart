...
class test44 extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<test44> {
...
class BeckDepressionTest extends StatefulWidget {
  ...
  BeckDepressionTest({required this.isDarkMode, required this.onThemeChanged});
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('درجة الاكتئاب: $totalScore\nالحالة: $result'),
          actions: [
            TextButton(
              child: Text('موافق'),
              onPressed: () {
